...
// Teste 3 — Caso de borda da função minLength
describe("validators.minLength", () => {
    it("aceita um texto com o tamanho exatamente igual ao mínimo", () => {
        // Passando os parâmetros na ordem correta da função: (valor, minimo, nomeCampo)
